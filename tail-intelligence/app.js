...
async function loadDashboard() {
  try {
    const [platform, daily, latest, day20, day21, day22] = await Promise.all([
    ...
    const mergedDaily = [latest, day20, day21, day22].reduce((state, update) => mergeDaily(state, update), daily);
